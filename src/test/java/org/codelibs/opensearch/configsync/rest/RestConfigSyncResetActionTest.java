...
public class RestConfigSyncResetActionTest extends TestCase {

    private RestConfigSyncResetAction action;
    ...
    protected void setUp() throws Exception {
        ...
        action = new RestConfigSyncResetAction(settings, mockRestController, mockConfigSyncService);
    }
    ...
    public void test_getName() {
        assertEquals("configsync_reset_action", action.getName());
    }
    ...
    public void test_routes_contains_post_method() {
        ...
        assertEquals("/_configsync/reset", route.getPath());
    }
    ...
    public void test_routes_are_unmodifiable() {
        ...
        try {
            routes.add(new BaseRestHandler.Route(RestRequest.Method.GET, "/_test"));
    ...
    public void test_multiple_instances_are_independent() {
        ...
        RestConfigSyncResetAction action2 = new RestConfigSyncResetAction(settings, mockRestController, mockService2);
    ...
    public void test_constructor_with_different_settings() {
        Settings customSettings = Settings.builder()
                .put("configsync.file_updater.enabled", true)
                .build();

        RestConfigSyncResetAction customAction = new RestConfigSyncResetAction(customSettings, mockRestController, mockConfigSyncService);

        assertNotNull(customAction);
        assertEquals("configsync_reset_action", customAction.getName());
    }
}
