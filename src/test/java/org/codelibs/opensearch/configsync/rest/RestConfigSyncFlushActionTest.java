...
public class RestConfigSyncFlushActionTest extends TestCase {

    private RestConfigSyncFlushAction action;
    ...
    protected void setUp() throws Exception {
        ...
        action = new RestConfigSyncFlushAction(settings, mockRestController, mockConfigSyncService);
    }
    ...
    public void test_getName() {
        assertEquals("configsync_flush_action", action.getName());
    }
    ...
    public void test_routes_contains_post_method() {
        ...
        assertEquals("/_configsync/flush", route.getPath());
    }
    ...
    public void test_multiple_instances_are_independent() {
        ...
        RestConfigSyncFlushAction action2 = new RestConfigSyncFlushAction(settings, mockRestController, mockService2);
    ...
    public void test_constructor_with_different_settings() {
        Settings customSettings = Settings.builder()
                .put("configsync.flush_interval", "10s")
                .build();

        RestConfigSyncFlushAction customAction = new RestConfigSyncFlushAction(customSettings, mockRestController, mockConfigSyncService);

        assertNotNull(customAction);
        assertEquals("configsync_flush_action", customAction.getName());
    }
}
